...
const navItems = [
  ...
  { name: 'Connect', href: '#portfolios', label: 'View my portfolios' },
];
...
export function Footer() {
  ...
  return (
    <footer 
      ...
      className="bg-[rgba(var(--bg-rgb),0.3)] text-gray-400 py-4 sm:py-6 md:py-8 border-t border-blue-500/10 relative z-20"
    >
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <div className="space-y-3 sm:space-y-4">
            <h3 className="text-base sm:text-lg font-semibold text-blue-400 mb-2 sm:mb-4">Quick Links</h3>
            <div className="grid grid-cols-2 gap-2">
              {navItems.map((item) => (
                <button
                  key={item.name}
                  onClick={() => scrollToSection(item.href)}
                  className="text-left text-gray-400 hover:text-blue-400 transition-colors flex items-center gap-2 group text-sm sm:text-base"
          ...
          <div className="space-y-3 sm:space-y-4">
            <h3 className="text-base sm:text-lg font-semibold text-blue-400 mb-2 sm:mb-4">Connect</h3>
            <div className="flex flex-col gap-2 sm:gap-3">
              <a href="https://github.com/Jhalak6104" target="_blank" rel="noopener noreferrer" 
                 className="footer-link hover:text-blue-400 transition-colors flex items-center gap-2 group text-sm sm:text-base"
              ...
              <a href="https://www.linkedin.com/in/jhalak-jain-666590243/" target="_blank" rel="noopener noreferrer" 
                 className="footer-link hover:text-blue-400 transition-colors flex items-center gap-2 group text-sm sm:text-base"
          ...
          <div className="space-y-2 sm:space-y-3 lg:text-right">
            <div className="flex items-center gap-2 text-blue-500 lg:justify-end">
