...
export const Hero = memo(function Hero() {
  const handleDownloadCV = () => {
    ...
    link.download = 'Jhalak_Jain_Resume.pdf';
    link.target = '_blank';
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-8 md:gap-12">
          ...
          >
            <div className="absolute inset-0 blur-2xl opacity-20">
              <div className="w-60 sm:w-80 h-60 sm:h-80 bg-blue-500/20 rounded-full mx-auto animate-pulse"></div>
            </div>
            ...
            <h1 className="flex flex-col items-center md:items-start gap-2 md:gap-4 z-10 relative">
              ...
              <div className="flex items-center gap-2 whitespace-nowrap">
                <span>I'm&nbsp;</span>
                <motion.span
                  className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-gray-600 transition-all duration-300"
                  whileHover={
                    reduceMotion
                      ? undefined
                      : {
            ...
            <p className="text-gray-400 max-w-3xl mx-auto md:mx-0 leading-relaxed font-light z-10 relative">
              Passionate about proactive threat hunting, continuous learning in cybersecurity, and building scalable solutions. I specialize in{' '}
              <span className="text-blue-400 font-medium">penetration testing</span>,{' '}
              <span className="text-blue-400 font-medium">incident response</span>, and
              <span className="text-blue-400 font-medium"> developing security-focused applications</span>.
            </p>
          ...
          >
            ...
            >
              <div className="absolute inset-0 blur-2xl opacity-30 pointer-events-none">
                <div className="w-full h-full bg-gradient-to-r from-blue-500/20 to-gray-500/20 rounded-full"></div>
              </div>
              <img
            ...
            <motion.div
              className="absolute -top-4 -right-4 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-blue-400/40 backdrop-blur-sm"
              animate={reduceMotion ? undefined : { y: [0, -10, 0] }}
              transition={reduceMotion ? undefined : { duration: 4, repeat: Infinity }}
              aria-hidden="true"
            />
            <motion.div
              className="absolute -bottom-6 -left-4 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gray-400/40 backdrop-blur-sm"
              animate={reduceMotion ? undefined : { y: [0, 10, 0] }}
